...
public class PartitionSubListTest {
	...
	@InjectMocks
	public PartitionsListUtils partitionsListUtilsMock;

	@Test
	public void testPartition_empty() throws IllegalArgumentException {
		
		List<Integer> source = Collections.emptyList();
		List<List<Integer>> partitions = partitionsListUtilsMock.partitionInteger(source, 1);
	...
	public void testPartition_1_2() throws IllegalArgumentException {
		List<Integer> source = Collections.singletonList(1);
		List<List<Integer>> partitions = partitionsListUtilsMock.partitionInteger(source, 2);
		assertEquals(1, partitions.size());
		assertEquals(Collections.singletonList(1), partitions.get(0));
	}
	...
	public void testPartition_n_n() throws IllegalArgumentException {
		...
		List<List<Integer>> partitions = partitionsListUtilsMock.partitionInteger(source, 200);
		assertEquals(1, partitions.size());
	}
